...
from .models_gurobi import UCModel
...
from .models_gurobi import generate_model
from .models_gurobi import solve_model
...
class Simulator:
    ...
    def __init__(self,
        ...
        if solver != 'gurobi':
            raise Exception("This version of Vatic only supports gurobi solver to \
                        so the faster implementation could be enabled. Please \
                        use the previous Vatic 0.4.0 to use other solvers.")
